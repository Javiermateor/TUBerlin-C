...
char* render_exercise_1d(Canvas t, exercise_1d_data testcase)
{
    ...
    for(int i = 0; i < testcase.number_of_circles; i++){
        ...
        snprintf(temp_string,130,TESTRUNNER_LABEL "\t\t%zu. x-Koordinate der linkesten Pixel = %d, "
...
int main(int argc, char const *argv[]) {
    Tester tester = tester_new(argc - 1, argv[1], argv[2],
                               "clang -std=c11 -g -Wall "TEST_NAME".c 04ex_helpers.c -o "TEST_NAME".o -lm && ./"TEST_NAME".o");
